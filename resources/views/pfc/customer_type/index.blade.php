...
@section('head-action')
	@if($gc->checkModuleAccess('customer_type_add', 'PFC'))
		<a href="{{ route('pfc.customer.type.add') }}" class="btn btn-link text-decoration-none">{{ __('ADD') }}</a>
	@endif
...
@section('content')
  <div class="row">
    <div class="col-md-12">
      <table id="customer_types" class="table cell-border compact table-striped hover display nowrap" width="100%">
        <thead>
          <tr>
            <th scope="col">{{ __('Customer Type Name') }}</th>
