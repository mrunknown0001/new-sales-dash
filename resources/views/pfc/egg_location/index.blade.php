...
@section('head-action')
	@if($gc->checkModuleAccess('location_add', 'PFC'))
		<a href="{{ route('pfc.egg.location.add') }}" class="btn btn-link text-decoration-none">{{ __('ADD') }}</a>
	@endif
    ...
    $(document).on('click', '#edit', function (e) {
      ...
      Swal.fire({
        ...
        if (result.value) {
          ...
          var update_url = "{{ route('pfc.egg.location.edit') }}"
      ...
      Swal.fire({
        ...
        if (result.value) {
          ...
          $.ajax({
            ...
            url: "{{ route('pfc.egg.location.delete') }}",
