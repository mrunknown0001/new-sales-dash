...
@section('head-action')
	@if($gc->checkModuleAccess('product_add', 'PFC'))
		<a href="{{ route('pfc.product.add') }}" class="btn btn-link text-decoration-none">{{ __('ADD') }}</a>
	@endif
...
@section('content')
  <div class="row">
    <div class="col-md-12">
      <table id="products" class="table cell-border compact table-striped hover display nowrap" width="100%">
        <thead>
          <tr>
    ...
    $(document).on('click', '#edit', function (e) {
      ...
      Swal.fire({
        ...
        if (result.value) {
          ...
          var update_url = "{{ route('pfc.product.edit') }}"
