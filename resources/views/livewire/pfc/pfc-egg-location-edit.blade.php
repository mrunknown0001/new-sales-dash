<div>
	...
	<form wire:submit.prevent="update" autocomplete="off">
		@csrf
		<div class="mb-3">
		  <label for="location_name" class="form-label required">Egg Location Name</label>
		...
		<div class="mb-3">
		  <label for="location_code" class="form-label required">Egg Location Code</label>
		...
		<div class="mb-3">
		  <label for="location_description" class="form-label">Egg Location Description</label>
