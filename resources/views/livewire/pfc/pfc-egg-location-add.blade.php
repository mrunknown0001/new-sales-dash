<div>
	...
	<form wire:submit.prevent="save" autocomplete="off">
		@csrf
		<div class="mb-3">
		  <label for="egg_location_name" class="form-label required">Egg Location Name</label>
		...
		<div class="mb-3">
		  <label for="egg_location_code" class="form-label required">Egg Location Code</label>
		...
		<div class="mb-3">
		  <label for="egg_location_description" class="form-label">Egg Location Description</label>
