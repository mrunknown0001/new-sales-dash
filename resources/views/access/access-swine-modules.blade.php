...
<div class="form-group">
	<h4>{{ __('Farm:') }}</h4>
	<ul class="list-inline">
		<li class="list-inline-item"><input type="checkbox" {{ \App\Http\Controllers\AccessController::checkAccess($user_id, $farm, 'farm_module') ? 'checked' : '' }} value="farm_module" name="access[]" wire:model="access" id="farm_module"> <label for="farm_module">{{ __('Module') }}</label></li>
		<li class="list-inline-item"><input type="checkbox" {{ \App\Http\Controllers\AccessController::checkAccess($user_id, $farm, 'farm_add') ? 'checked' : '' }} value="farm_add" name="access[]" wire:model="access" id="farm_add"> <label for="farm_add">{{ __('Add') }}</label></li>
		<li class="list-inline-item"><input type="checkbox" {{ \App\Http\Controllers\AccessController::checkAccess($user_id, $farm, 'farm_edit') ? 'checked' : '' }} value="farm_edit" name="access[]" wire:model="access" id="farm_edit"> <label for="farm_edit">{{ __('Edit') }}</label></li>
		<li class="list-inline-item"><input type="checkbox" {{ \App\Http\Controllers\AccessController::checkAccess($user_id, $farm, 'farm_delete') ? 'checked' : '' }} value="farm_delete" name="access[]" wire:model="access" id="farm_delete"> <label for="farm_delete">{{ __('Delete') }}</label></li>
	</ul>
</div>
<div class="form-group">
	<h4>{{ __('Department:') }}</h4>
	<ul class="list-inline">
		<li class="list-inline-item"><input type="checkbox" {{ \App\Http\Controllers\AccessController::checkAccess($user_id, $farm, 'department_module') ? 'checked' : '' }} value="department_module" name="access[]" wire:model="access" id="department_module"> <label for="department_module">{{ __('Module') }}</label></li>
		<li class="list-inline-item"><input type="checkbox" {{ \App\Http\Controllers\AccessController::checkAccess($user_id, $farm, 'department_add') ? 'checked' : '' }} value="department_add" name="access[]" wire:model="access" id="department_add"> <label for="department_add">{{ __('Add') }}</label></li>
		<li class="list-inline-item"><input type="checkbox" {{ \App\Http\Controllers\AccessController::checkAccess($user_id, $farm, 'department_edit') ? 'checked' : '' }} value="department_edit" name="access[]" wire:model="access" id="department_edit"> <label for="department_edit">{{ __('Edit') }}</label></li>
		<li class="list-inline-item"><input type="checkbox" {{ \App\Http\Controllers\AccessController::checkAccess($user_id, $farm, 'department_delete') ? 'checked' : '' }} value="department_delete" name="access[]" wire:model="access" id="department_delete"> <label for="department_delete">{{ __('Delete') }}</label></li>
	</ul>
</div>
<div class="form-group">
	<h4>{{ __('Product:') }}</h4>
...
<div class="form-group">
	...
	<ul class="list-inline">
		<li class="list-inline-item"><input type="checkbox" {{ \App\Http\Controllers\AccessController::checkAccess($user_id, $farm, 'product_category_module') ? 'checked' : '' }} value="product_category_module" name="access[]" wire:model="access" id="product_category_module"> <label for="product_category_module">{{ __('Module') }}</label></li>
		<li class="list-inline-item"><input type="checkbox" {{ \App\Http\Controllers\AccessController::checkAccess($user_id, $farm, 'product_category_add') ? 'checked' : '' }} value="product_category_add" name="access[]" wire:model="access" id="product_category_add"> <label for="product_category_add">{{ __('Add') }}</label></li>
		<li class="list-inline-item"><input type="checkbox" {{ \App\Http\Controllers\AccessController::checkAccess($user_id, $farm, 'product_category_edit') ? 'checked' : '' }} value="product_category_edit" name="access[]" wire:model="access" id="product_category_edit"> <label for="product_category_edit">{{ __('Edit') }}</label></li>
		<li class="list-inline-item"><input type="checkbox" {{ \App\Http\Controllers\AccessController::checkAccess($user_id, $farm, 'product_category_delete') ? 'checked' : '' }} value="product_category_delete" name="access[]" wire:model="access" id="product_category_delete"> <label for="product_category_delete">{{ __('Delete') }}</label></li>
	</ul>
</div>
<div class="form-group">
	<h4>{{ __('Customer:') }}</h4>
...
<div class="form-group">
	...
	<ul class="list-inline">
		<li class="list-inline-item"><input type="checkbox" {{ \App\Http\Controllers\AccessController::checkAccess($user_id, $farm, 'sale_status_module') ? 'checked' : '' }} value="sale_status_module" name="access[]" wire:model="access" id="sale_status_module"> <label for="sale_status_module">{{ __('Module') }}</label></li>
		<li class="list-inline-item"><input type="checkbox" {{ \App\Http\Controllers\AccessController::checkAccess($user_id, $farm, 'sale_status_add') ? 'checked' : '' }} value="sale_status_add" name="access[]" wire:model="access" id="sale_status_add"> <label for="sale_status_add">{{ __('Add') }}</label></li>
		<li class="list-inline-item"><input type="checkbox" {{ \App\Http\Controllers\AccessController::checkAccess($user_id, $farm, 'sale_status_edit') ? 'checked' : '' }} value="sale_status_edit" name="access[]" wire:model="access" id="sale_status_edit"> <label for="sale_status_edit">{{ __('Edit') }}</label></li>
		<li class="list-inline-item"><input type="checkbox" {{ \App\Http\Controllers\AccessController::checkAccess($user_id, $farm, 'customer_delete') ? 'checked' : '' }} value="customer_delete" name="access[]" wire:model="access" id="customer_delete"> <label for="customer_delete">{{ __('Delete') }}</label></li>
	</ul>
</div>
<div class="form-group">
	...
	<ul class="list-inline">
		<li class="list-inline-item"><input type="checkbox" {{ \App\Http\Controllers\AccessController::checkAccess($user_id, $farm, 'classification_module') ? 'checked' : '' }} value="classification_module" name="access[]" wire:model="access" id="classification_module"> <label for="classification_module">{{ __('Module') }}</label></li>
		<li class="list-inline-item"><input type="checkbox" {{ \App\Http\Controllers\AccessController::checkAccess($user_id, $farm, 'sale_status_add') ? 'checked' : '' }} value="sale_status_add" name="access[]" wire:model="access" id="sale_status_add"> <label for="sale_status_add">{{ __('Add') }}</label></li>
		<li class="list-inline-item"><input type="checkbox" {{ \App\Http\Controllers\AccessController::checkAccess($user_id, $farm, 'sale_status_edit') ? 'checked' : '' }} value="sale_status_edit" name="access[]" wire:model="access" id="sale_status_edit"> <label for="sale_status_edit">{{ __('Edit') }}</label></li>
		<li class="list-inline-item"><input type="checkbox" {{ \App\Http\Controllers\AccessController::checkAccess($user_id, $farm, 'customer_delete') ? 'checked' : '' }} value="customer_delete" name="access[]" wire:model="access" id="customer_delete"> <label for="customer_delete">{{ __('Delete') }}</label></li>
	</ul>
