...
<div class="form-group">
	<h4>{{ __('Area:') }}</h4>
	<ul class="list-inline">
		<li class="list-inline-item"><input type="checkbox" {{ $access->checkAccess($user_id, $farm, 'area_module') ? 'checked' : '' }} value="area_module" name="access[]" wire:model="access" id="area_module"> <label for="area_module">{{ __('Module') }}</label></li>
		<li class="list-inline-item"><input type="checkbox" {{ $access->checkAccess($user_id, $farm, 'area_add') ? 'checked' : '' }} value="area_add" name="access[]" wire:model="access" id="area_add"> <label for="area_add">{{ __('Add') }}</label></li>
		<li class="list-inline-item"><input type="checkbox" {{ $access->checkAccess($user_id, $farm, 'area_edit') ? 'checked' : '' }} value="area_edit" name="access[]" wire:model="access" id="area_edit"> <label for="area_edit">{{ __('Edit') }}</label></li>
		<li class="list-inline-item"><input type="checkbox" {{ $access->checkAccess($user_id, $farm, 'area_delete') ? 'checked' : '' }} value="area_delete" name="access[]" wire:model="access" id="area_delete"> <label for="area_delete">{{ __('Delete') }}</label></li>
	</ul>
</div>
<div class="form-group">
	<h4>{{ __('Type of Tech Visit:') }}</h4>
	<ul class="list-inline">
		<li class="list-inline-item"><input type="checkbox" {{ $access->checkAccess($user_id, $farm, 'type_of_tech_visit_module') ? 'checked' : '' }} value="type_of_tech_visit_module" name="access[]" wire:model="access" id="type_of_tech_visit_module"> <label for="type_of_tech_visit_module">{{ __('Module') }}</label></li>
		<li class="list-inline-item"><input type="checkbox" {{ $access->checkAccess($user_id, $farm, 'type_of_tech_visit_add') ? 'checked' : '' }} value="type_of_tech_visit_add" name="access[]" wire:model="access" id="type_of_tech_visit_add"> <label for="type_of_tech_visit_add">{{ __('Add') }}</label></li>
		<li class="list-inline-item"><input type="checkbox" {{ $access->checkAccess($user_id, $farm, 'type_of_tech_visit_edit') ? 'checked' : '' }} value="type_of_tech_visit_edit" name="access[]" wire:model="access" id="type_of_tech_visit_edit"> <label for="type_of_tech_visit_edit">{{ __('Edit') }}</label></li>
		<li class="list-inline-item"><input type="checkbox" {{ $access->checkAccess($user_id, $farm, 'type_of_tech_visit_delete') ? 'checked' : '' }} value="type_of_tech_visit_delete" name="access[]" wire:model="access" id="type_of_tech_visit_delete"> <label for="type_of_tech_visit_delete">{{ __('Delete') }}</label></li>
	</ul>
</div>
<div class="form-group">
	<h4>{{ __('Customer:') }}</h4>
...
<div class="form-group">
	...
	<ul class="list-inline">
		<li class="list-inline-item"><input type="checkbox" {{ $access->checkAccess($user_id, $farm, 'type_of_account_module') ? 'checked' : '' }} value="type_of_account_module" name="access[]" wire:model="access" id="type_of_account_module"> <label for="type_of_account_module">{{ __('Module') }}</label></li>
		<li class="list-inline-item"><input type="checkbox" {{ $access->checkAccess($user_id, $farm, 'type_of_account_add') ? 'checked' : '' }} value="type_of_account_add" name="access[]" wire:model="access" id="type_of_account_add"> <label for="type_of_account_add">{{ __('Add') }}</label></li>
		<li class="list-inline-item"><input type="checkbox" {{ $access->checkAccess($user_id, $farm, 'type_of_account_edit') ? 'checked' : '' }} value="type_of_account_edit" name="access[]" wire:model="access" id="type_of_account_edit"> <label for="type_of_account_edit">{{ __('Edit') }}</label></li>
		<li class="list-inline-item"><input type="checkbox" {{ $access->checkAccess($user_id, $farm, 'type_of_account_delete') ? 'checked' : '' }} value="type_of_account_delete" name="access[]" wire:model="access" id="type_of_account_delete"> <label for="type_of_account_delete">{{ __('Delete') }}</label></li>
	</ul>
</div>
<div class="form-group">
	<h4>{{ __('Product Type:') }}</h4>
	<ul class="list-inline">
		<li class="list-inline-item"><input type="checkbox" {{ $access->checkAccess($user_id, $farm, 'product_type_module') ? 'checked' : '' }} value="product_type_module" name="access[]" wire:model="access" id="product_type_module"> <label for="product_type_module">{{ __('Module') }}</label></li>
		<li class="list-inline-item"><input type="checkbox" {{ $access->checkAccess($user_id, $farm, 'product_type_add') ? 'checked' : '' }} value="product_type_add" name="access[]" wire:model="access" id="product_type_add"> <label for="product_type_add">{{ __('Add') }}</label></li>
		<li class="list-inline-item"><input type="checkbox" {{ $access->checkAccess($user_id, $farm, 'product_type_edit') ? 'checked' : '' }} value="product_type_edit" name="access[]" wire:model="access" id="product_type_edit"> <label for="product_type_edit">{{ __('Edit') }}</label></li>
		<li class="list-inline-item"><input type="checkbox" {{ $access->checkAccess($user_id, $farm, 'product_type_delete') ? 'checked' : '' }} value="product_type_delete" name="access[]" wire:model="access" id="product_type_delete"> <label for="product_type_delete">{{ __('Delete') }}</label></li>
	</ul>
</div>
<div class="form-group">
	<h4>{{ __('Product:') }}</h4>
